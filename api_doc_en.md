...
- [Spot API Reference](#b5)
  - [open-api](#b6) ([Api Demo](https://github.com/bitbank3/bitbankfile/blob/main/demo.txt))
...
Welcome to [BitBank](https://www.bitbank3.com/index) API document for developers.
...
Before signing any request, you must generate an API key via [Exchange’s official website ](https://www.bitbank3.com/index)【User Center】-【API】. After generating the key, there are three things you must bear in mind:
...
Generate a string to be signed
    -   [open-api Demo](https://github.com/bitbank3/bitbankfile/blob/main/demo.txt)
...
The root URL for REST access：``` https://openapi.bitbank3.com ```
...
public class WsTest {
    ...
    public static void main(String[] args) {
        try {
//wsurl 
            String url = "wss://ws.bitbank3.com/kline-api/ws";
...
//Thread does not end, waiting for new messages，www.bitbank3.com Generally, a new deal will return in about a minute
            while (true) {
                Thread.sleep(1000);
            }
